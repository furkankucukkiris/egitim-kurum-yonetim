  ...
  if (groups.length === 0) {
    return (
      <div className="rounded-2xl border border-border bg-surface px-6 py-16 text-center shadow-sm">
        ...
        <h3 className="mt-5 text-lg font-bold text-text-primary">Bu ay için tahakkuk kaydı yok</h3>

        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-text-secondary">
          Aşağıdaki &ldquo;Bu ayın tahakkuklarını oluştur&rdquo; ile mevcut kayıtlı öğrenciler için
          bu ayın ödemelerini oluşturabilirsiniz.
        </p>
      </div>
    );
  }
