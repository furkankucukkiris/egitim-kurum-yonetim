...
export default async function PaymentsPage() {
  ...
  return (
    <>
      <PageHeader title="Ödemeler" description="Tahakkuk, tahsilat, açık borç ve kasaya alınan nakit hareketleri." action={<button className="rounded-xl bg-terra-700 px-4 py-3 text-sm font-semibold text-white">+ Ödeme al</button>} />
